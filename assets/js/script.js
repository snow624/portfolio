...
function initWorkHeroGallery() {
    ...
    const galleries = {
        ...
        "laravel-vending-system.html": [
            "../img/works/laravel.png",
            "../img/works/laravel-01.png",
            "../img/works/laravel-02.png",
            "../img/works/laravel-03.png",
            "../img/works/laravel-04.png",
            "../img/works/laravel-05.png",
        ],
        "spring-boot-system.html": [
            "../img/works/SpringBoot.png",
            "../img/works/SpringBoot-01.png",
            "../img/works/SpringBoot-02.png",
            "../img/works/SpringBoot-03.png",
            "../img/works/SpringBoot-04.png",
        ],
